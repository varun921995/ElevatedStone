			...
			<Container>
				<Row>
					<Col>
						...
						<p className="our-services-text">
							Should you have any non-traditional work that falls outside of our
							scope, we will be just as happy to help your clients find the
							appropriate contacts in the industry to suit the project needs.
						</p>
					</Col>
				</Row>
			</Container>
