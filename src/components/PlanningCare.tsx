...
const PlanningCare = () => {
  ...
  return (
    <>
      ...
      <div className="background-wrapper mb-5">
        <Container>
          <Row>
            <Col>
              <p className="text">
                At Elevated Stone Design, our Customer Care Strategy is centred
                around creating exceptional experiences for our clients through
                every phase of their journey with us. We prioritize quality
                control with thorough inspections and client approval processes,
                ensuring that every project meets our high standards.
              </p>
              <p className="text">
